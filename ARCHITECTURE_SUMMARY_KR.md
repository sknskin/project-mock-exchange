# Mock Exchange 아키텍처 설계 요약 (한글)

## 전체 개요

Mock Exchange는 실시간 모의 주식/암호화폐 거래 플랫폼으로, 마이크로서비스 아키텍처 기반의 프로덕션급 시스템입니다. 1,000명 이상의 동시 트레이더를 지원하며, 수평 확장이 가능하고, Kubernetes 환경에 배포할 수 있도록 설계되었습니다.
...
| Phase 3 | 11-13주 | 소셜/알림 (**완료**) | 1:1/그룹 채팅, 가격 알림, 알림 센터, 온라인 상태, 통계 대시보드, 관리자 강제 퇴장 |
