...
| http://localhost:4000/mypage | 마이페이지 (프로필, 거래 통계) |
| http://localhost:4000/help | 도움말 |
| http://localhost:4000/admin/users | 관리자 - 사용자 관리 (ADMIN) |
| http://localhost:4000/admin/stats | 관리자 - 통계 (ADMIN) |
| http://localhost:4000/admin/announcements | 관리자 - 공지사항 관리 (ADMIN) |
| http://localhost:4000/admin/settings | 관리자 - 시스템 설정 (ADMIN) |
| http://localhost:4000/admin/health | 관리자 - 서비스 상태 (ADMIN) |
| http://localhost:4000/admin/audit | 관리자 - 감사 보고서 (ADMIN) |
